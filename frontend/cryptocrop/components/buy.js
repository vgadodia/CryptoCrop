...
export default class Buy extends React.Component  {
  ...
  render(){
    ...
    <View style={styles.container}>
         ...
         <Text style={{position:'relative',fontSize:20,margin:'auto', textAlign:'center', color:'#2D3748', fontFamily:'Avenir', marginTop:'10%'}}>Buy crops</Text>
        ...
        <Text style={{backgroundColor:'#1A2C70', width:'50%', alignSelf:'center', borderRadius:10, padding:'5%', textAlign:'center', color:'#FFF', fontFamily:'Avenir', marginTop:'10%'}} onPress={()=>this._buy()}>BUY</Text>
